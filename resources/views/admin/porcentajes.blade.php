...
<div class="flex justify-between">
    ...
    <h1 class="text-lg ml-2"><i class="fas fa-cog"></i> Configuración de porcentajes de bonos</h1>
    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#comision" data-toggle="tab">Activación para comisión</a></li>
            </ul>
        </div>
