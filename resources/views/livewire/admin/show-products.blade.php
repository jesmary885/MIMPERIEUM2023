<div>
    ...
    <div class="card-header">
        <div class="flex items-center">
            ...
            <a class="btn btn-md ml-auto btn-primary" href="{{route('admin.products.create')}}">
                Agregar producto
            </a>
        </div>
        </div>
                        ...
                        @foreach ($products as $product)
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-2 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="{{ route('admin.products.edit', $product) }}" class="text-blue-600 text-lg hover:text-blue-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </td>

                                <td class="px-3 py-4 whitespace-nowrap text-center">
                                    @livewire('admin.add-products', ['product' => $product],key(01.,'$product->id'))
                                </td>
