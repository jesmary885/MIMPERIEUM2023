            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="py-0 text-lg text-gray-800"> Información de área "Productos"</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="flex justify-between">
                            <div class="form-group w-full mr-2 mt-2">
                                    <label class="w-full text-justify text-gray-600 text-md">Descripción</label>
                                    <input type="text" wire:model="descripcion" class="form-control rounded" id="formGroupExampleInput">
