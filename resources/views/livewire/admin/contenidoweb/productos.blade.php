<div>
    ...
    <div class="flex justify-between mt-2 mb-2">
        ...
        @livewire('admin.contenidoweb.productos-edit', ['accion' => 'create'])
                ...
                @foreach ($imagenes as $imagen)
                    <tr class="bg-gray-100 border-gray-700 hover:bg-gray-200">
                        ...
                        <td class="text-center">{{$imagen->texto1}}</td>
                            <td class="text-center"> {{$imagen->texto2}}</td>
                     
                            <td class="text-center">
                                @livewire('admin.contenidoweb.productos-edit', ['imagen' => $imagen,'accion' => 'edit'],key($imagen->id))
                            </td>
                        </tr>
                @endforeach
            </tbody>
